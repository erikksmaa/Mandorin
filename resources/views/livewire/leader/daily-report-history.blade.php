<div class="mt-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('leader.reports.create', $program->id) }}" class="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-xl text-sm font-medium transition">
            Tambah Laporan
        </a>
    </div>
    ...
    @if($reports->isEmpty())
        <div class="bg-white border border-slate-200 rounded-xl shadow-sm">
            <x-empty-state
                ...
                description="Belum ada laporan harian untuk program ini. Mulai tambahkan laporan untuk memantau progres pekerjaan."
                action-url="{{ route('leader.reports.create', $program->id) }}"
