<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white border border-slate-200 shadow-sm rounded-2xl p-5 border-l-4 border-l-amber-500">
        ...
        <div class="bg-white border border-slate-200 shadow-sm rounded-2xl p-5 border-l-4 border-l-navy">
        ...
        <div class="bg-white border border-slate-200 shadow-sm rounded-2xl p-5 border-l-4 border-l-green-500">
    ...
    <!-- CTA Banner -->
    <div class="bg-navy rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between mb-8 text-white shadow-md">
        <div>
        ...
        <a href="{{ route('customer.contractors.index') }}" class="mt-4 md:mt-0 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-medium transition whitespace-nowrap inline-block text-center">
            Cari Sekarang
        </a>
    </div>

    <!-- Recent Projects -->
    <h2 class="text-xl font-bold text-slate-800 mb-4" style="font-family: 'Big Shoulders Display', sans-serif;">Proyek Terbaru</h2>
    <div class="space-y-4">
